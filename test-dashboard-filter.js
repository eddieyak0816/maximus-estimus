...
async function testDashboardFilter() {
  ...
  const isDraftActive = await draftCard.locator('..').evaluate(el =>
  ...
  const isDraftStillActive = await draftCard.locator('..').evaluate(el =>
    el.classList.contains('stat-card-active')
  );
  ...
  const isTotalActive = await totalCard.locator('..').evaluate(el =>
    el.classList.contains('stat-card-active')
  );
