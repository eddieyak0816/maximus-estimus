...
export default function BathroomQuestions({ data, onUpdate }: Props) {
  ...
  return (
    <div className="assess-tab">
      ...
      <CollapseSection title="2 — Timeline" defaultOpen={false}>
      ...
      <CollapseSection title="3 — Tub & Shower" defaultOpen={false}>
      ...
      <CollapseSection title="4 — Vanity & Fixtures" defaultOpen={false}>
        <p className="assess-hint">Select all that apply</p>
      ...
      <CollapseSection title="5 — Tile Work" defaultOpen={false}>
      ...
      <CollapseSection title="6 — Grout Color" defaultOpen={false}>
      ...
      <CollapseSection title="7 — Tile Pattern" defaultOpen={false}>
      ...
      <CollapseSection title="8 — Lighting" defaultOpen={false}>
      ...
      <CollapseSection title="9 & 10 — Trades" defaultOpen={false}>
      ...
      <CollapseSection title="11 — Permits" defaultOpen={false}>
        {['Yes', 'No', 'Unknown'].map(opt =>
          <CheckOpt key={opt} label={opt} selected={data.permits === opt} onToggle={() => u('permits', opt)} round />
        )}
      </CollapseSection>

      <CollapseSection title="12 — How Did You Hear About Us?" defaultOpen={false}>
      ...
      <CollapseSection title="13 — Special Notes" defaultOpen={false}>
