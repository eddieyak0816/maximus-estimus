...
export default function FlooringQuestions({ data, onUpdate }: Props) {
  ...
  return (
    <div className="assess-tab">
      <CollapseSection title="1 — Flooring Material" defaultOpen={false}>
      ...
      <CollapseSection title="2 — Remove Existing Flooring?" defaultOpen={false}>
      ...
      <CollapseSection title="3 — Subfloor Repairs?" defaultOpen={false}>
      ...
      <CollapseSection title="4 — Underlayment Needed?" defaultOpen={false}>
        <div className="q-card">
          <div className="toggle-row">
      ...
      <CollapseSection title="5 — Stair Nosing Needed?" defaultOpen={false}>
        <div className="q-card">
          <div className="toggle-row">
      ...
      <CollapseSection title="6 — Matching Existing Flooring?" defaultOpen={false}>
        <div className="q-card">
          <div className="toggle-row">
      ...
      <CollapseSection title="7 — Timeline" defaultOpen={false}>
      ...
      <CollapseSection title="8 — How Did You Hear About Us?" defaultOpen={false}>
      ...
      <CollapseSection title="9 — Special Notes" defaultOpen={false}>
