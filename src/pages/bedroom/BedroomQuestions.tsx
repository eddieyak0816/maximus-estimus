...
export default function BedroomQuestions({ data, onUpdate }: Props) {
  ...
  const availableQuestions = [
    ...
    { key: 'flooring', label: 'Flooring & Closets' },
  ...
  const fieldsPerQuestion: Record<string, string[]> = {
    ...
    flooring: ['floringIncluded', 'closetWork'],
  ...
  const sectionHasContent = (fields: (keyof BedroomQuestions)[]): boolean => {
  ...
  const getDefaultVisibleQuestions = () => {
    ...
    availableQuestions.forEach(q => {
      const fields = (fieldsPerQuestion[q.key] || []) as (keyof BedroomQuestions)[];
  ...
  return (
    <>
      ...
      <div className="assess-tab">
        ...
        {isQuestionVisible('flooring') && <CollapseSection title="Flooring & Closets" defaultOpen={false}>
          <div className="form-field">
